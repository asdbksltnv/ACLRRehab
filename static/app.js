const APP_DATA = {
  ui: {
    uz: {
      ...
      registerSub: "Protokolni admin biriktiradi. Siz faqat hisob yaratib, ma'lumotlarni kiriting.",
      labelEmail: "Email",
      labelGmail: "Gmail",
      labelUsername: "Username",
      labelLogin: "Gmail / username",
      labelPassword: "Parol",
      ...
      protocolAssignedNote: "Protokolni admin biriktiradi.",
      ...
      errorRequired: "Email, username va parol kerak.",
      errorEmailExists: "Bu email allaqachon ro'yxatdan o'tgan.",
      errorUsernameExists: "Bu username band.",
      errorGmailRequired: "Faqat Gmail orqali ro'yxatdan o'tish mumkin.",
      errorInvalidLogin: "Gmail/username yoki parol noto'g'ri.",
    ...
    ru: {
      ...
      registerSub: "Протокол назначает админ. Вам нужно создать аккаунт и ввести данные.",
      labelEmail: "Email",
      labelGmail: "Gmail",
      labelUsername: "Username",
      labelLogin: "Gmail / username",
      ...
      protocolAssignedNote: "Протокол назначает админ.",
      ...
      errorRequired: "Нужны gmail, username и пароль.",
      errorEmailExists: "Этот email уже зарегистрирован.",
      errorUsernameExists: "Этот username занят.",
      errorGmailRequired: "Регистрация только через Gmail.",
      errorInvalidLogin: "Неверный Gmail/username или пароль.",
